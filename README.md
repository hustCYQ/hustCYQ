...
- :page_facing_up: Published **10+ papers** in TASE, TIM, CVPR, ECCV, etc. (**6 First Author**). Reviewer of **20+ IEEE Trans. and Top Conf.** (TIP, TCYB, TSMC, TNNLS, TCSVT, TASE, TII, TMech, CVPR, ICCV, NeurIPS, ICRA, etc.)
